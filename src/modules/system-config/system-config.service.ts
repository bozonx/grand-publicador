...
export class SystemConfigService implements OnModuleInit {
    ...
    ensureConfigExists() {
        try {
            ...
            if (!fs.existsSync(configPath)) {
                this.logger.log(`Configuration file not found at ${configPath}. Copying from ${defaultPath}`);
    ...
    reloadConfig() {
        try {
            ...
            this.currentConfig = yaml.load(substitutedContent);
     ...
     */
    updateConfig(newYamlContent: string) {
        try {
