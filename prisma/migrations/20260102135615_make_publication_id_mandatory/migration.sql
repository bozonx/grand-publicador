/*
  ...
  - Made the column `publication_id` on table `posts` required. This step will fail if there are existing NULL values in that column.
...
INSERT INTO "new_posts" ("archived_at", "archived_by", "author_comment", "author_id", "channel_id", "content", "created_at", "description", "id", "language", "media_files", "meta", "post_date", "post_type", "publication_id", "published_at", "scheduled_at", "social_media", "status", "tags", "title", "updated_at") SELECT "archived_at", "archived_by", "author_comment", "author_id", "channel_id", "content", "created_at", "description", "id", "language", "media_files", "meta", "post_date", "post_type", "publication_id", "published_at", "scheduled_at", "social_media", "status", "tags", "title", "updated_at" FROM "posts";
DROP TABLE "posts";
