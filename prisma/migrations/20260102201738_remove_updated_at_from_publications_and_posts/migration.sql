...
INSERT INTO "new_publications" ("archived_at", "archived_by", "author_comment", "content", "created_at", "created_by", "description", "id", "language", "media_files", "meta", "post_date", "post_type", "project_id", "status", "tags", "title", "translation_group_id") SELECT "archived_at", "archived_by", "author_comment", "content", "created_at", "created_by", "description", "id", "language", "media_files", "meta", "post_date", "post_type", "project_id", "status", "tags", "title", "translation_group_id" FROM "publications";
