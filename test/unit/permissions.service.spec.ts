...
describe('PermissionsService (unit)', () => {
    ...
    describe('checkProjectAccess', () => {
        ...
        it('should throw ForbiddenException if project not found', async () => {
            ...
            await expect(service.checkProjectAccess(projectId, userId)).rejects.toThrow(ForbiddenException);
        });
    ...
    describe('checkProjectPermission', () => {
        ...
        it('should grant access to owner regardless of roles', async () => {
            ...
            await expect(service.checkProjectPermission(projectId, userId, allowedRoles)).resolves.not.toThrow();
        });
        ...
        it('should throw ForbiddenException for member with insufficient role', async () => {
            ...
            await expect(service.checkProjectPermission(projectId, userId, allowedRoles)).rejects.toThrow(ForbiddenException);
        });
