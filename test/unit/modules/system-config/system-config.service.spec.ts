...
const { SystemConfigService } = await import('../../../../src/modules/system-config/system-config.service.js');
...
plainKey: value
    ...
    describe('updateConfig', () => {
        it('should write new yaml content to file and reload', () => {
            ...
            expect(mockFs.writeFileSync).toHaveBeenCalledWith(expect.stringContaining('app-config.yaml'), newYaml, 'utf8');
