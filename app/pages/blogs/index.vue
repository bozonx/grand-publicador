...
const { blogs, isLoading, error, fetchBlogs, deleteBlog, canEdit, canDelete, getRoleDisplayName } = useBlogs()
...
<template>
  <div>
          ...
          <div class="flex items-start justify-between">
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-3 mb-2">
                ...
                <UBadge 
                  :color="getRoleBadgeColor(blog.role)" 
                  variant="subtle"
                  size="sm"
                >
    ...
    <div v-else class="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center">
      <UIcon name="i-heroicons-book-open" class="w-12 h-12 mx-auto text-gray-400 dark:text-gray-500 mb-4" />
