...
watch([selectedAdminFilter, searchQuery], () => {
  const isAdminValue = selectedAdminFilter.value === null 
    ? null 
    : selectedAdminFilter.value === 'true'
...
<template>
  <div>
    ...
    >
      <UIcon name="i-heroicons-users" class="w-12 h-12 mx-auto text-gray-400 dark:text-gray-500 mb-4" />
            ...
            >
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right">
                <UButton
                  ...
                  variant="ghost"
                  size="sm"
                  :icon="user.is_admin ? 'i-heroicons-shield-exclamation' : 'i-heroicons-shield-check'"
        ...
        <div class="p-6">
          <div class="flex items-center gap-4 mb-4">
            <div 
              ...
              :class="userToToggle?.is_admin 
                ? 'bg-amber-100 dark:bg-amber-900/30' 
                : 'bg-green-100 dark:bg-green-900/30'
              "
            >
              <UIcon 
                :name="userToToggle?.is_admin ? 'i-heroicons-shield-exclamation' : 'i-heroicons-shield-check'" 
                class="w-6 h-6"
                :class="userToToggle?.is_admin 
          ...
          <p class="text-gray-600 dark:text-gray-400 mb-2">
            {{ userToToggle?.is_admin 
              ? t('admin.revokeAdminConfirm', 'Are you sure you want to revoke admin rights from this user?')
              : t('admin.grantAdminConfirm', 'Are you sure you want to grant admin rights to this user?')
            }}
          </p>

          <div v-if="userToToggle" class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg mb-6">
            <UAvatar
